...
alt_generate(
  ...
  output_path     = "../src/altwrap_integer.cpp",
...
alt_generate(
  ...
  output_path     = "../src/altwrap_real.cpp",
  exclude_methods = "Duplicate_")
...
alt_generate(
  ...
  output_path     = "../src/altwrap_logical.cpp",
...
alt_generate(
  ...
  output_path     = "../src/altwrap_raw.cpp",
...
alt_generate(
  ...
  output_path     = "../src/altwrap_string.cpp",
