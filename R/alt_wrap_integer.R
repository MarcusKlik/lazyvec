...
alt_wrap_integer <- function(altrep_vec, vec_id) {
  ...
  listeners <- c(
    listener_integer_length,
    listener_integer_dataptr_or_null,
    listener_integer_get_region,
    listener_integer_element,
    listener_integer_dataptr,
    listener_integer_is_sorted,
    listener_integer_no_na,
    listener_integer_sum,
    listener_integer_min,
    listener_integer_max,
    listener_integer_inspect,
    listener_integer_unserialize_ex,
    listener_integer_serialized_state,
    listener_integer_duplicate_ex,
    listener_integer_coerce,
    listener_integer_extract_subset
  )
...
listener_integer_length <- function(x) {
  cat(crayon::italic(crayon::cyan(x[[1]], ": ALTREP length : result = ")), display_parameter(x[[2]]), "\n", sep = "")
}


listener_integer_dataptr_or_null <- function(is_non_null_pointer) {
...
listener_integer_get_region <- function(arguments) {
