...
Rbyte lazyvec_raw_Elt_method(SEXP sx, R_xlen_t i)
{
  Rbyte element = RAW_ELT(LAZYVEC_PAYLOAD(sx), i);
  ...
  call_r_interface(elt_listener, Rf_ScalarRaw(element), LAZYVEC_PARENT_ENV(sx));
