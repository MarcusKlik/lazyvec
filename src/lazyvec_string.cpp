...
SEXP lazyvec_string_Elt_method(SEXP sx, R_xlen_t i)
{
  SEXP element = STRING_ELT(LAZYVEC_PAYLOAD(sx), i);
  ...
  call_r_interface(elt_listener, Rf_ScalarString(element), LAZYVEC_PARENT_ENV(sx));
