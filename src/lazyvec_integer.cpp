...
R_xlen_t lazyvec_integer_Get_region_method(SEXP x, R_xlen_t i, R_xlen_t n, int *buf)
{
  ...
  // convert to C_TYPE
  int* elements = (int*)(INTEGER(vec_elems));
...
int lazyvec_integer_Is_sorted_method(SEXP x)
{
  // custom payload
  SEXP user_data = PROTECT(LAZYVEC_USER_DATA(x));
...
int lazyvec_integer_No_NA_method(SEXP x)
{
  // custom payload
  SEXP user_data = PROTECT(LAZYVEC_USER_DATA(x));
...
SEXP lazyvec_integer_Sum_method(SEXP x, Rboolean na_rm)
{
  // custom payload
  SEXP user_data = PROTECT(LAZYVEC_USER_DATA(x));
...
SEXP lazyvec_integer_Min_method(SEXP x, Rboolean na_rm)
{
  // custom payload
  SEXP user_data = PROTECT(LAZYVEC_USER_DATA(x));
...
SEXP lazyvec_integer_Max_method(SEXP x, Rboolean na_rm)
{
  // custom payload
  SEXP user_data = PROTECT(LAZYVEC_USER_DATA(x));
...
SEXP lazyvec_integer_DuplicateEX_method(SEXP x, Rboolean deep)
{
  // custom payload
  SEXP user_data = PROTECT(LAZYVEC_USER_DATA(x));
...
SEXP lazyvec_integer_Coerce_method(SEXP x, int type)
{
...
SEXP lazyvec_integer_Extract_subset_method(SEXP x, SEXP indx, SEXP call)
{
  // custom payload
  SEXP user_data = PROTECT(LAZYVEC_USER_DATA(x));
