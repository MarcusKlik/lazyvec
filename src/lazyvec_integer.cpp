...
int lazyvec_integer_Elt_method(SEXP sx, R_xlen_t i)
{
  int element = INTEGER_ELT(LAZYVEC_PAYLOAD(sx), i);
  ...
  call_r_interface(elt_listener, Rf_ScalarInteger(element), LAZYVEC_PARENT_ENV(sx));
