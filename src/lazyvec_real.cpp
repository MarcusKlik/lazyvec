...
int lazyvec_real_Is_sorted_method(SEXP sx)
{
  int is_sorted = REAL_IS_SORTED(LAZYVEC_PAYLOAD(sx));
...
int lazyvec_real_No_NA_method(SEXP sx)
{
  int no_na = REAL_NO_NA(LAZYVEC_PAYLOAD(sx));
...
SEXP lazyvec_real_Min_method(SEXP sx, Rboolean na_rm)
{
  SEXP result_min = PROTECT(ALTREAL_MIN(LAZYVEC_PAYLOAD(sx), na_rm));
...
SEXP lazyvec_real_Coerce_method(SEXP sx, int type)
{
...
SEXP lazyvec_real_Extract_subset_method(SEXP sx, SEXP indx, SEXP call)
{
