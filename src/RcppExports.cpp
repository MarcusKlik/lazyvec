...
RcppExport SEXP _lazyvec_trigger_duplicate(SEXP xSEXP, SEXP deepSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type x(xSEXP);
    Rcpp::traits::input_parameter< int >::type deep(deepSEXP);
    rcpp_result_gen = Rcpp::wrap(trigger_duplicate(x, deep));
    return rcpp_result_gen;
END_RCPP
}
// trigger_coerce
...
RcppExport SEXP _lazyvec_lazyvec_is_expanded(SEXP lazy_vecSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type lazy_vec(lazy_vecSEXP);
    rcpp_result_gen = Rcpp::wrap(lazyvec_is_expanded(lazy_vec));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_lazyvec_trigger_duplicate", (DL_FUNC) &_lazyvec_trigger_duplicate, 2},
    ...
    {"_lazyvec_lazyvec_is_expanded", (DL_FUNC) &_lazyvec_lazyvec_is_expanded, 1},
